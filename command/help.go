...
var helpTopics = map[string][]string{
	...
	"chat": {
		"  /chat              List available chat sessions",
		"  /chat new          Create a new chat session",
		"  /chat <number>     Switch to the chat session by number",
		"  /chat copy         Copy the complete current chat to a new session",
		"  /chat copy <index> Copy the current chat through message <index>",
		"  Session numbers start at 1; message indexes start at 0.",
	},
	"copy": {
