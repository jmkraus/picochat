...
// determineLineBreak splits a full input line at its last space. The text before
// the space becomes the completed line and the following word remains editable
// on the next line.
//
// Parameters:
//
//	currentLine ([]rune) - the current input line
//
// Returns:
//
//	[]rune - completed line
